...
//when we click of a particular filter then only than color shows
for (let i = 0; i < toolBoxColors.length; i++) {
    toolBoxColors[i].addEventListener("click", (e) => {
        ...
        filteredTickets.forEach((ticketObj, idx) => {//for each a higher order function
            createTicket(ticketObj.ticketColor, ticketObj.ticketTask, ticketObj.ticketID);
        })
    })
...
//press shift to add in the web page
...
//set the all modal value to default
